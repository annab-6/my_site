...
class Order(models.Model):
    user = models.ForeignKey(to=User, on_delete=models.SET_DEFAULT, blank=True, null=True, verbose_name="User",
                             default=None)
    timestamp = models.DateTimeField(auto_now_add=True, verbose_name="Order creation date")
    ...
    payment_on_get = models.BooleanField(default=False, verbose_name="Delivery address")
...
class OrderItem(models.Model):
    ...
    timestamp = models.DateTimeField(auto_now_add=True, verbose_name="Date of sale")
